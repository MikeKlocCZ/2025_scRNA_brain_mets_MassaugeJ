...
# Read-in data  MOUSE
sce <- readRDS("results/join_sce/brainMets_hg38_ensdb104_sce.rds")
dim(sce )
#39197 18107
...
pdf("plots/dicard_genes_CANCER.pdf", width = 4, height = 6)
par(mfrow=c(3,1))
...
pdf("plots/Mito_discard_CANCER.pdf", width = 8, height = 4)
par(mfrow=c(1,2))
...
pdf("plots/MA_discarded_cells_CANCER.pdf", width = 6, height = 4)
...
pdf("plots/HTOs_profiles_ambient_estimation_CANCER.pdf")
par(mfrow=c(2,2))
gridExtra::grid.arrange(
...
pdf("plots/HTOs_assignment_exp1_CANCER.pdf")
par(mfrow=c(1,2))
gridExtra::grid.arrange(
...
pdf("plots/HashTag_RankExp1_CANCER.pdf", width = 10, height = 5)
...
dev.off()
pdf("plots/HashTag_RankExp2_CANCER.pdf", width = 10, height = 5)
