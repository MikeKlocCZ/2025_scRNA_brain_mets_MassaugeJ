...
#  [ [1] "mt-Atp6" "mt-Co3"  "mt-Co2"  "mt-Co1"  "mt-Cytb" "mt-Nd4"  "mt-Nd2" 
#[8] "mt-Nd1"  "Apoe"    "Cst3"    "mt-Nd5"  "Sparcl1" "Fth1"    "mt-Nd3" 
#[15] "Atp1a2"  "Actb"    "Lars2"   "Tmsb4x"  "Mt1"     "mt-Nd4l" "Itm2b"  
#[22] "Son"     "Slc1a2"  "Tpt1"    "Ckb"     "Qk"      "Psap"    "Macf1"  
#[29] "Cd81"    "Rpl13"  
