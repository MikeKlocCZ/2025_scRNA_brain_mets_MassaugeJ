...
for(cell.type in cell.types){
 ...
 # head(best_upstream_ligands)
  ...
  pdf(paste0("figures/ligands_histogram_",cell.type, "_on_mets.pdf"), width = 5, height = 5)
  ...
  pdf(paste0("figures/dotplot_",cell.type,".pdf"), width = 7, height = 4)
  ...
  pdf(paste0("figures/target_regulatory_potential",cell.type, "_on_mets.pdf"), width = 8, height = 5)
  ...
  pdf(paste0("figures/ligand_receptor_regulatory_potential",cell.type, "_on_mets.pdf"), width = 8, height = 5)
  ...
  pdf(paste0("figures/Barplot_location_",cell.type,".pdf"), width = 8, height = 4.5)
  ...
  pdf(paste0("figures/CombinedNicheNet_",cell.type,".pdf"), width = 18, height = 15)
  print(combined_plot)
  dev.off()
}
