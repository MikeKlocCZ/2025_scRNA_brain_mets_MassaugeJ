...
write.csv(ligand_activities %>% top_n(20, aupr_corrected) %>% arrange(-aupr_corrected), paste0("top20_predictedLigandsHCC_combinedTME.csv"))
  ...
  pdf(paste0("figures/ligands_histogram_combinedTME_on_mets.pdf"), width = 5, height = 5)
  ...
  pdf(paste0("figures/dotplot_combinedTME.pdf"), width = 7, height = 4)
  ...
  pdf(paste0("figures/target_regulatory_potential_TME_on_mets.pdf"), width = 8, height = 5)
  ...
  pdf(paste0("figures/ligand_receptor_regulatory_potential_combinedTME_on_mets.pdf"), width = 8, height = 5)
  ...
  pdf(paste0("figures/Barplot_location_combinedTME.pdf"), width = 8, height = 4.5)
  ...
  tsne1 <- plotReducedDim(sce.TME[,sce.TME$cell.line == "HCC1954"], "TSNE", colour_by="clusters", text_colour = "black", text_by="clusters",text_size = 4,add_legend = FALSE) +ggtitle("HCC1954")
  tsne.velo <- plotTSNE(sce.TME[,sce.TME$cell.line == "HCC1954"], colour_by="velocity_pseudotime") +
  ...
  tsne.loc <- plotReducedDim(sce.TME[,sce.TME$cell.line == "HCC1954"], "TSNE", colour_by="location", text_colour = "black", text_by="location",text_size = 4,add_legend = FALSE) +ggtitle("HCC1954")
  ...
  pdf(paste0("figures/CombinedNicheNet_combinedTME_HCC1954.pdf"), width = 18, height = 16)
  print(combined_plot)
  dev.off()
